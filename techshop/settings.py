...
ALLOWED_HOSTS = os.environ.get(
    "ALLOWED_HOSTS",
    "127.0.0.1,localhost,192.168.101.25"
).split(",")

CSRF_TRUSTED_ORIGINS = [
    url for url in os.environ.get("CSRF_TRUSTED_ORIGINS", "").split(",")
    if url
]
...
ASGI_APPLICATION = "techshop.asgi.application"
...
PAYPAL_CLIENT_ID = os.environ.get("PAYPAL_CLIENT_ID", "AYbvN-T3--RIDuCRqpi_")
